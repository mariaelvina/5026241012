        ...
        <div class="card-body">
            <form action="{{ route('siswa.store') }}" method="POST" onsubmit="return validasiForm()">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="NRP" id="NRP" class="form-control" maxlength="10" value="{{ old('NRP') }}" placeholder="Masukkan NRP...">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="Kelas" id="Kelas" class="form-control" maxlength="5" value="{{ old('Kelas') }}" placeholder="Contoh: IF-A">
                    </div>
                </div>
