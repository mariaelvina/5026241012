...
@section('konten')
    ...
    <form action="{{ route('kursi.store') }}" method="POST" onsubmit="return validasiForm()">
        ...
        <p>
            ...
            <input type="text" name="merkkursi" id="merkkursi" maxlength="30" value="{{ old('merkkursi') }}">
        </p>

         <p>
            <label>Stok Kursi</label><br>
            <input type="number" name="stockkursi" id="stockkursi" min="0" value="{{ old('stockkursi') }}">
        </p>
